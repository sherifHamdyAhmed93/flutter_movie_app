...
import 'package:flutter_movie_app/c_widgets/horizontal_movie_item.dart';
import 'package:flutter_movie_app/c_widgets/play_button_widget.dart';
import 'package:flutter_movie_app/c_widgets/recommended_movie_item.dart';
import 'package:flutter_movie_app/model/Genres.dart';
  ...
  Widget buildSimilarMoviesSection(List<MovieModel> movies) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('more like this', style: Theme.of(context).textTheme.headlineSmall),
