...
import 'package:flutter_movie_app/data_model/belongs_to_collection.dart';
import 'package:flutter_movie_app/data_model/production_companies.dart';
import 'package:flutter_movie_app/data_model/production_countries.dart';
import 'package:flutter_movie_app/data_model/spoken_languages.dart';
...
class MovieModel {
  ...
  String? getFullPosterImagePath({int imageWidth = 500}){
    return '${ApiConstants.imagesURL}$imageWidth$posterPath';
  }

  String getDateWithGenresAndDuration(){
    return '${Utils.formatDate(releaseDate ?? '')} ${Utils.convertMinutesToFormatedTime(runtime ?? 0)}';
  }
